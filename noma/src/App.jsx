...
const DESTINATIONS = [
  ...
  // ══ 🇺🇸 NORTEAMÉRICA ══
  { id:201, name:"Nueva York", country:"Estados Unidos", region:"Norteamérica", emoji:"🇺🇸",
    price:{mochilero:480,equilibrado:1100,premium:3500}, rating:4.8, reviews:9821,
    verified:"hace 1 día", verifiedBy:156, tag:"🗽 Imperdible", code:"JFK",
    img:"https://images.unsplash.com/photo-1522083165195-3424ed129620?w=900&q=85",
    coords:{lat:40.7128,lon:-74.0060}, vibe:"Ciudad + Cultura", clima:"12°C · Variable",
    bestMonth:"Sep–Nov", language:"Inglés", currency:"USD", safety:78, authentic:74,
    gems:["Brooklyn Bridge al amanecer — sin nadie y gratis","Smorgasburg: mercado foodie local cada domingo","The High Line 7am: parque elevado sin turistas"],
    warnings:["Metro seguro pero confuso — descarga NYC Subway app","Propina 20% es obligatoria social y culturalmente"] },

  { id:202, name:"Chicago", country:"Estados Unidos", region:"Norteamérica", emoji:"🇺🇸",
    price:{mochilero:320,equilibrado:780,premium:2400}, rating:4.7, reviews:5432,
    verified:"hace 2 días", verifiedBy:89, tag:"🏙️ Ciudad del viento", code:"ORD",
    img:"https://images.unsplash.com/photo-1477959858617-67f85cf4f1df?w=900&q=85",
    coords:{lat:41.8781,lon:-87.6298}, vibe:"Arquitectura + Gastronomía", clima:"10°C · Variable",
    bestMonth:"Jun–Sep", language:"Inglés", currency:"USD", safety:72, authentic:79,
    gems:["Chicago Riverwalk al atardecer (gratis)","Millennium Park 6am: El Cloud Gate solo para ti","Giordano's deep dish pizza: la auténtica, no la turística"],
    warnings:["Invierno brutal — hasta -20°C con wind chill","Algunas zonas del south side evitar de noche"] },

  { id:203, name:"Vancouver", country:"Canadá", region:"Norteamérica", emoji:"🇨🇦",
    price:{mochilero:380,equilibrado:900,premium:2800}, rating:4.8, reviews:4123,
    verified:"hace 2 días", verifiedBy:67, tag:"🏔️ Mar + Montaña", code:"YVR",
    img:"https://images.unsplash.com/photo-1559511260-66a654ae982a?w=900&q=85",
    coords:{lat:49.2827,lon:-123.1207}, vibe:"Naturaleza + Ciudad", clima:"10°C · Lluvioso",
    bestMonth:"Jun–Sep", language:"Inglés/Francés", currency:"CAD", safety:88, authentic:81,
    gems:["Stanley Park en bici al amanecer (la vuelta completa son 9km)","Granville Island Market: desayuno local sin tours","Squamish a 1h: senderismo épico sin multitudes de Banff"],
    warnings:["Lluvia casi todo el año — ropa impermeable esencial","Costo de vida muy alto — comer fuera es caro"] },

  { id:204, name:"Ciudad de Quebec", country:"Canadá", region:"Norteamérica", emoji:"🇨🇦",
    price:{mochilero:280,equilibrado:680,premium:2000}, rating:4.8, reviews:2341,
    verified:"hace 3 días", verifiedBy:41, tag:"💎 Europa sin cruzar el Atlántico", code:"YQB",
    img:"https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=900&q=85",
    coords:{lat:46.8139,lon:-71.2080}, vibe:"Historia + Gastronomía", clima:"8°C · Variable",
    bestMonth:"Jun–Sep", language:"Francés", currency:"CAD", safety:94, authentic:88,
    gems:["Old Quebec a las 6am: ciudad medieval sin turistas","Carnaval de Quebec en febrero: experiencia única mundial","Île d'Orléans: isla rural a 15 min del centro"],
    warnings:["Invierno muy frío (-25°C)","Poco inglés en zonas fuera del centro"] },

  // ══ 🇪🇺 EUROPA NUEVOS ══
  { id:205, name:"Praga", country:"República Checa", region:"Europa", emoji:"🇨🇿",
    price:{mochilero:220,equilibrado:520,premium:1600}, rating:4.9, reviews:7823,
    verified:"hace 1 día", verifiedBy:112, tag:"🏰 Cuento de hadas", code:"PRG",
    img:"https://images.unsplash.com/photo-1541849546-216549ae216d?w=900&q=85",
    coords:{lat:50.0755,lon:14.4378}, vibe:"Historia + Cerveza", clima:"10°C · Variable",
    bestMonth:"Abr–Jun", language:"Checo", currency:"CZK", safety:92, authentic:82,
    gems:["Puente Carlos a las 5:30am: solo tú y los músicos madrugadores","Vinohrady: el barrio donde viven los locales","Cerveza Pilsner en U Fleků ($1.80 el litro)"],
    warnings:["Turismo masivo en casco histórico julio–agosto","Taxi del aeropuerto solo por app — precio fijo"] },

  { id:206, name:"Viena", country:"Austria", region:"Europa", emoji:"🇦🇹",
    price:{mochilero:320,equilibrado:780,premium:2400}, rating:4.8, reviews:5678,
    verified:"hace 2 días", verifiedBy:87, tag:"🎭 Clásica", code:"VIE",
    img:"https://images.unsplash.com/photo-1516550893923-42d28e5677af?w=900&q=85",
    coords:{lat:48.2082,lon:16.3738}, vibe:"Arte + Gastronomía", clima:"12°C · Variable",
    bestMonth:"Abr–Jun", language:"Alemán", currency:"EUR", safety:95, authentic:78,
    gems:["Naschmarkt al amanecer: el mercado más auténtico de Viena","Prater en bicicleta gratis","Café Central: desayuno vienés por €8 — la experiencia completa"],
    warnings:["Validar siempre el ticket de metro — multas muy altas","Agosto: muchos museos con horario reducido"] },

  { id:207, name:"Dubrovnik", country:"Croacia", region:"Europa", emoji:"🇭🇷",
    price:{mochilero:280,equilibrado:680,premium:2200}, rating:4.8, reviews:4321,
    verified:"hace 2 días", verifiedBy:63, tag:"👑 Juego de Tronos", code:"DBV",
    img:"https://images.unsplash.com/photo-1555990793-da11153b2473?w=900&q=85",
    coords:{lat:42.6507,lon:18.0944}, vibe:"Historia + Mar", clima:"22°C · Mediterráneo",
    bestMonth:"May–Jun", language:"Croata", currency:"EUR", safety:94, authentic:75,
    gems:["Murallas 7am: las mismas de GoT sin multitudes ($35)","Isla Lokrum en kayak propio","Kotor en Montenegro a 2h — igual de hermosa, sin turistas"],
    warnings:["Julio–Agosto: masificación extrema y calor brutal","Precios se triplican en temporada alta"] },

  { id:208, name:"Budapest", country:"Hungría", region:"Europa", emoji:"🇭🇺",
    price:{mochilero:200,equilibrado:480,premium:1500}, rating:4.8, reviews:6234,
    verified:"hace 1 día", verifiedBy:94, tag:"💎 La Perla del Danubio", code:"BUD",
    img:"https://images.unsplash.com/photo-1570461226513-e08b58a52c71?w=900&q=85",
    coords:{lat:47.4979,lon:19.0402}, vibe:"Historia + Noche", clima:"12°C · Variable",
    bestMonth:"Abr–Jun", language:"Húngaro", currency:"HUF", safety:88, authentic:84,
    gems:["Széchenyi Baths: baños termales al amanecer ($18)","Ruin bars en Kazinczy utca: cultura única mundial","Buda Castle hill al amanecer — vistas al Danubio gratis"],
    warnings:["Festival Sziget en agosto = precios x3","Cambiadores de dinero en calle = estafa"] },

  { id:209, name:"Lisboa", country:"Portugal", region:"Europa", emoji:"🇵🇹",
    price:{mochilero:320,equilibrado:750,premium:2200}, rating:4.9, reviews:8934,
    verified:"hace 1 día", verifiedBy:134, tag:"🌊 Saudade", code:"LIS",
    img:"https://images.unsplash.com/photo-1555881400-74d7acaacd8b?w=900&q=85",
    coords:{lat:38.7223,lon:-9.1393}, vibe:"Historia + Fado", clima:"18°C · Mediterráneo",
    bestMonth:"Mar–Jun", language:"Portugués", currency:"EUR", safety:90, authentic:83,
    gems:["Eléctrico 28 de punta a punta ($3 el tour más barato)","LX Factory domingo: mercado bohemio local","Tasca do Chico: fado auténtico sin cover — reserva martes"],
    warnings:["Verano muy masificado — precios altos","Pickpockets en el tranvía 28"] },

  // ══ 🌎 LATAM NUEVOS ══
  { id:210, name:"Ciudad de Panamá", country:"Panamá", region:"Latinoamérica", emoji:"🇵🇦",
    price:{mochilero:220,equilibrado:520,premium:1600}, rating:4.5, reviews:1823,
    verified:"hace 3 días", verifiedBy:28, tag:"🌉 Hub de las Américas", code:"PTY",
    img:"https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=900&q=85",
    coords:{lat:8.9936,lon:-79.5197}, vibe:"Ciudad + Canal", clima:"28°C · Tropical",
    bestMonth:"Ene–Mar", language:"Español", currency:"USD", safety:75, authentic:76,
    gems:["Casco Viejo: Cartagena sin las multitudes","Canal de Panamá desde Miraflores (gratis verlo)","Mercado de Mariscos: ceviche fresco por $4"],
    warnings:["Zona fuera del Casco Viejo puede ser insegura de noche","Humedad extrema abril–noviembre"] },

  { id:211, name:"Quito", country:"Ecuador", region:"Latinoamérica", emoji:"🇪🇨",
    price:{mochilero:180,equilibrado:420,premium:1300}, rating:4.6, reviews:2134,
    verified:"hace 3 días", verifiedBy:31, tag:"🌋 Capital del mundo", code:"UIO",
    img:"https://images.unsplash.com/photo-1597659840990-5f84abe8ef7b?w=900&q=85",
    coords:{lat:-0.1807,lon:-78.4678}, vibe:"Historia + Naturaleza", clima:"16°C · Fresco",
    bestMonth:"Jun–Sep", language:"Español", currency:"USD", safety:74, authentic:87,
    gems:["Centro histórico más grande de Latinoamérica (UNESCO)","Teleférico al volcán Pichincha ($8.50)","Mercado Central: almuerzo completo por $2.50"],
    warnings:["Altitud 2850m — primer día descansar","No mostrar cámara cara en zonas concurridas"] },

  { id:212, name:"Asunción", country:"Paraguay", region:"Latinoamérica", emoji:"🇵🇾",
    price:{mochilero:130,equilibrado:300,premium:900}, rating:4.3, reviews:654,
    verified:"hace 5 días", verifiedBy:11, tag:"💎 La más ignorada", code:"ASU",
    img:"https://images.unsplash.com/photo-1526392060635-9d6019884377?w=900&q=85",
    coords:{lat:-25.2867,lon:-57.6470}, vibe:"Historia + Cultura", clima:"26°C · Cálido",
    bestMonth:"May–Sep", language:"Español/Guaraní", currency:"PYG", safety:72, authentic:91,
    gems:["Loma San Jerónimo: el barrio más antiguo y auténtico","Mercado 4: el mercado más grande de Sudamérica","Tereré con locales — la experiencia cultural definitiva"],
    warnings:["Verano muy caliente y húmedo (>40°C)","Infraestructura turística muy limitada"] },

  { id:213, name:"Medellín", country:"Colombia", region:"Latinoamérica", emoji:"🇨🇴",
    price:{mochilero:240,equilibrado:560,premium:1600}, rating:4.7, reviews:4532,
    verified:"hace 1 día", verifiedBy:67, tag:"🌟 Transformación épica", code:"MDE",
    img:"https://images.unsplash.com/photo-1597659840990-5f84abe8ef7b?w=900&q=85",
    coords:{lat:6.2442,lon:-75.5812}, vibe:"Ciudad + Innovación", clima:"22°C · Primavera eterna",
    bestMonth:"Todo el año", language:"Español", currency:"COP", safety:74, authentic:86,
    gems:["Metro Cable gratis con tarjeta local — vistas épicas","Barrio Laureles: donde comen los paisas","Feria de las Flores en agosto: la fiesta más auténtica"],
    warnings:["No usar teléfono en la calle sin precaución","Algunos barrios periféricos evitar de noche"] },

  // ══ 🌍 ÁFRICA NUEVOS ══
  { id:214, name:"El Cairo", country:"Egipto", region:"África", emoji:"🇪🇬",
    price:{mochilero:180,equilibrado:420,premium:1400}, rating:4.7, reviews:5432,
    verified:"hace 2 días", verifiedBy:71, tag:"🏺 Faraónico", code:"CAI",
    img:"https://images.unsplash.com/photo-1539650116574-75c0c6d73f6e?w=900&q=85",
    coords:{lat:30.0444,lon:31.2357}, vibe:"Historia + Misterio", clima:"28°C · Seco",
    bestMonth:"Oct–Abr", language:"Árabe", currency:"EGP", safety:76, authentic:88,
    gems:["Pirámides al amanecer sin tour — llega a las 6am","Khan el-Khalili a las 9pm: el bazar de noche sin turistas","Crucero en felucca por el Nilo ($5 la hora)"],
    warnings:["Regatear absolutamente todo — precio inicial x5","Guías no oficiales muy insistentes en zonas turísticas"] },

  { id:215, name:"Accra", country:"Ghana", region:"África", emoji:"🇬🇭",
    price:{mochilero:160,equilibrado:380,premium:1200}, rating:4.5, reviews:876,
    verified:"hace 4 días", verifiedBy:16, tag:"💎 África occidental auténtica", code:"ACC",
    img:"https://images.unsplash.com/photo-1547471080-7cc2caa01a7e?w=900&q=85",
    coords:{lat:5.6037,lon:-0.1870}, vibe:"Cultura + Playa", clima:"28°C · Tropical",
    bestMonth:"Nov–Mar", language:"Inglés/Twi", currency:"GHS", safety:80, authentic:93,
    gems:["Makola Market: el mercado más vibrante de África occidental","Labadi Beach: la playa favorita de los ghaneses","Jamestown: barrio colonial con arte urbano explosivo"],
    warnings:["Tráfico extremo en Accra — moverse en Uber siempre","Temporada de lluvias abril–junio y sep–oct"] },

  { id:216, name:"Dar es Salaam", country:"Tanzania", region:"África", emoji:"🇹🇿",
    price:{mochilero:150,equilibrado:360,premium:1100}, rating:4.4, reviews:743,
    verified:"hace 4 días", verifiedBy:13, tag:"💎 Puerta al Serengeti", code:"DAR",
    img:"https://images.unsplash.com/photo-1548625149-720094d8f04e?w=900&q=85",
    coords:{lat:-6.7924,lon:39.2083}, vibe:"Naturaleza + Costa", clima:"28°C · Húmedo",
    bestMonth:"Jun–Oct", language:"Swahili/Inglés", currency:"TZS", safety:78, authentic:90,
    gems:["Ferry a Zanzibar ($35 — la mejor forma de llegar)","Kariakoo Market: mercado más auténtico de la ciudad","Coco Beach al atardecer con locales"],
    warnings:["Base para safaris al Serengeti y Kilimanjaro","Malaria presente — profilaxis obligatoria"] },

  // ══ 🌏 ASIA NUEVOS ══
  { id:217, name:"Singapur", country:"Singapur", region:"Asia", emoji:"🇸🇬",
    price:{mochilero:380,equilibrado:900,premium:3000}, rating:4.8, reviews:6789,
    verified:"hace 1 día", verifiedBy:98, tag:"🦁 El León Asiático", code:"SIN",
    img:"https://images.unsplash.com/photo-1525625293386-3f8f99389edd?w=900&q=85",
    coords:{lat:1.3521,lon:103.8198}, vibe:"Modernidad + Gastronomía", clima:"30°C · Húmedo",
    bestMonth:"Feb–Abr", language:"Inglés/Mandarín", currency:"SGD", safety:98, authentic:72,
    gems:["Hawker centres: cena Michelin por $4 (Maxwell Food Centre)","Gardens by the Bay a las 7am — gratis antes de abrir","Barrio árabe Kampong Glam: la Singapur que no sale en fotos"],
    warnings:["Chicle prohibido — multas absurdas","Uno de los países más caros de Asia"] },

  { id:218, name:"Manila", country:"Filipinas", region:"Asia", emoji:"🇵🇭",
    price:{mochilero:140,equilibrado:340,premium:1100}, rating:4.3, reviews:2341,
    verified:"hace 3 días", verifiedBy:38, tag:"🏝️ 7,641 islas", code:"MNL",
    img:"https://images.unsplash.com/photo-1528181304800-259b08848526?w=900&q=85",
    coords:{lat:14.5995,lon:120.9842}, vibe:"Playa + Cultura", clima:"28°C · Tropical",
    bestMonth:"Nov–May", language:"Filipino/Inglés", currency:"PHP", safety:72, authentic:85,
    gems:["Intramuros: ciudad colonial del siglo XVI","El Nido en Palawan — una de las mejores playas del mundo","Jeepney: el transporte más colorido y barato del mundo ($0.30)"],
    warnings:["Tráfico de Manila es legendariamente caótico","Temporada de tifones jun–oct — verificar antes"] },

  { id:219, name:"Kioto", country:"Japón", region:"Asia", emoji:"🇯🇵",
    price:{mochilero:320,equilibrado:780,premium:2500}, rating:5.0, reviews:8934,
    verified:"hace 1 día", verifiedBy:121, tag:"🏯 Japón eterno", code:"ITM",
    img:"https://images.unsplash.com/photo-1528360983277-13d401cdc186?w=900&q=85",
    coords:{lat:35.0116,lon:135.7681}, vibe:"Tradición + Templos", clima:"15°C · Variable",
    bestMonth:"Mar–May", language:"Japonés", currency:"JPY", safety:99, authentic:91,
    gems:["Fushimi Inari 5am: mil torii sin nadie","Arashiyama bamboo grove al amanecer (6am)","Nishiki Market: el supermercado más antiguo de Japón"],
    warnings:["Sakura = precios x2 y reservas con 6 meses","Propinas ofenden — nunca dejar propina"] },

  // ══ 🏝️ ISLAS ══
  { id:220, name:"Maldivas", country:"Maldivas", region:"Asia", emoji:"🇲🇻",
    price:{mochilero:280,equilibrado:680,premium:4000}, rating:4.9, reviews:3421,
    verified:"hace 2 días", verifiedBy:47, tag:"🏝️ Paraíso en tierra", code:"MLE",
    img:"https://images.unsplash.com/photo-1514282401047-d79a71a590e8?w=900&q=85",
    coords:{lat:3.2028,lon:73.2207}, vibe:"Playa + Lujo", clima:"30°C · Tropical",
    bestMonth:"Nov–Abr", language:"Dhivehi/Inglés", currency:"MVR", safety:94, authentic:78,
    gems:["Islas habitadas locales (Maafushi): Maldivas al 20% del precio","Snorkel con mantarrayas en Hanifaru Bay","Malé local market: desayuno local por $2"],
    warnings:["Resorts privados son carísimos — optar por guesthouses en islas locales","Alcohol solo en resorts y liveaboards"] },

  { id:221, name:"Gran Canaria", country:"España", region:"Europa", emoji:"🇪🇸",
    price:{mochilero:220,equilibrado:520,premium:1600}, rating:4.7, reviews:4532,
    verified:"hace 2 días", verifiedBy:58, tag:"🌴 Continente en miniatura", code:"LPA",
    img:"https://images.unsplash.com/photo-1483683804023-6ccdb62f86ef?w=900&q=85",
    coords:{lat:27.9202,lon:-15.5474}, vibe:"Playa + Naturaleza", clima:"22°C · Primavera eterna",
    bestMonth:"Todo el año", language:"Español", currency:"EUR", safety:92, authentic:80,
    gems:["Dunas de Maspalomas al amanecer — desierto en el Atlántico","Teror: pueblo colonial canario auténtico","Vegueta: el barrio histórico de Las Palmas sin turistas"],
    warnings:["Zona sur muy turística — mejor base en Las Palmas","Agosto: masificación total en playas del sur"] },

  { id:222, name:"Maui", country:"Estados Unidos", region:"Norteamérica", emoji:"🇺🇸",
    price:{mochilero:420,equilibrado:980,premium:3200}, rating:4.9, reviews:5678,
    verified:"hace 2 días", verifiedBy:76, tag:"🌺 Hawaii auténtico", code:"OGG",
    img:"https://images.unsplash.com/photo-1507525428034-b723cf961d3e?w=900&q=85",
    coords:{lat:20.7984,lon:-156.3319}, vibe:"Playa + Naturaleza", clima:"26°C · Tropical",
    bestMonth:"Abr–Jun", language:"Inglés/Hawaiano", currency:"USD", safety:91, authentic:76,
    gems:["Haleakalā al amanecer: ver el sol salir sobre las nubes ($30 reserva)","Road to Hana: 64 puentes, cascadas y selva virgen","Iao Valley: los locales van aquí, no a Ka'anapali"],
    warnings:["Coche de alquiler obligatorio — transporte público escaso","Reservar Haleakalā con semanas de anticipación"] },

  { id:223, name:"Phuket", country:"Tailandia", region:"Asia", emoji:"🇹🇭",
    price:{mochilero:160,equilibrado:400,premium:1400}, rating:4.6, reviews:7823,
    verified:"hace 1 día", verifiedBy:102, tag:"🏖️ Playa de ensueño", code:"HKT",
    img:"https://images.unsplash.com/photo-1537996194471-e657df975ab4?w=900&q=85",
    coords:{lat:7.9519,lon:98.3381}, vibe:"Playa + Fiesta", clima:"30°C · Tropical",
    bestMonth:"Nov–Abr", language:"Tailandés", currency:"THB", safety:82, authentic:70,
    gems:["Kata Noi Beach: la playa más bonita sin las masas de Patong","Mercado dominical de Phuket Town (no Bangla Road)","Isla Similan en barco local ($40 dia completo)"],
    warnings:["Patong Beach = turismo masivo y caro","May–Oct: monzón — playas cerradas y mar peligroso"] },
